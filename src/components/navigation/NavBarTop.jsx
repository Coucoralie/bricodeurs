...
const NavBarTop = () => {
	...
	return (
		<div className="fixed top-0 flex-row items-center justify-between hidden w-full h-20 px-16 bg-opacity-0 border border-b border-gray-200 bg-slate-50 lg:flex">
